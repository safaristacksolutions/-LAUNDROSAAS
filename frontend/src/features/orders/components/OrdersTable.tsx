...
const columns: Column<Order>[] = [
  ...
  { key: "customer_name", label: "Customer", render: (r) => r.customer_name ?? `#${r.customer}`, width: 150 },
  { key: "status", label: "Status", render: (r) => <StatusBadge status={r.status} />, width: 120 },
  { key: "total", label: "Total", render: (r) => formatKES(r.total), width: 100 },
